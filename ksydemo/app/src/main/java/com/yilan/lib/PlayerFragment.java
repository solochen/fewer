...
import com.yilan.lib.Qos.QosThread;
...
public class PlayerFragment extends Fragment {
    ...
    public static PlayerFragment getPlayerFragment(String url) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mVideoSurfaceView = (VideoSurfaceView) view.findViewById(R.id.player_surface);
        mQosView = (PlayerQosView) view.findViewById(R.id.qos_view);
        return view;
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mPlayerUrl = getArguments().getString("liveUrl");
        initMediaPlayer();
    }
...
//                    EventBus.getDefault().post(new PlayerEvent(PlayerEvent.PLAYER_LIVE_BUFFERING_END));
    ...
    private class UIHandler extends Handler {
        ...
        public UIHandler(PlayerFragment playerFragment) {
