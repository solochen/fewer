...
public class PlayerQosView extends FrameLayout {
    ...
    void init(Context context){
        ...
        View view = mInflater.inflate(R.layout.custom_lib_player_qos, this);

        mCpu = (TextView) findViewById(R.id.lib_player_cpu);
        mMemInfo = (TextView) findViewById(R.id.lib_player_mem);
        mVideoResolution = (TextView) findViewById(R.id.lib_player_re);
        mVideoBitrate = (TextView) findViewById(R.id.lib_player_br);
        mFrameRate = (TextView) findViewById(R.id.lib_player_fr);
        mCodecType = (TextView) findViewById(R.id.lib_player_codec);
        mServerIp = (TextView) findViewById(R.id.lib_player_ip);
        mPlayerUrl = (TextView) findViewById(R.id.lib_player_url);
        mSdkVersion = (TextView) findViewById(R.id.lib_player_sdk_version);
        mDNSTime = (TextView) findViewById(R.id.lib_player_dns_time);
        mHttpConnectionTime = (TextView) findViewById(R.id.lib_player_http_connection_time);
        mPlayerQos = (LinearLayout) findViewById(R.id.lib_player_qos);
        mFVST = (TextView) findViewById(R.id.lib_firstVideoStartTime);
        mBufferEmptyCount = (TextView) findViewById(R.id.lib_buffer_empty_count);
        mBufferEmptyDuration = (TextView) findViewById(R.id.lib_buffer_empty_duration);
        mBufferEmptyTimeMax = (TextView) findViewById(R.id.lib_buffer_empty_time_max);
        mQosInfoAll = (TextView) findViewById(R.id.lib_qos_info_all);
