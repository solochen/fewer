 ...
 */
 package com.yilan.lib.playerlib.utils.explosion;
...
//    private static final float X = ExplosionHelper.dp2Px(5);
//    private static final float Y = ExplosionHelper.dp2Px(20);
//    private static final float V = ExplosionHelper.dp2Px(2);
//    private static final float W = ExplosionHelper.dp2Px(1);

    private static final float X = ExplosionHelper.dp2Px(15);
    private static final float Y = ExplosionHelper.dp2Px(60);
    private static final float V = ExplosionHelper.dp2Px(6);
    private static final float W = ExplosionHelper.dp2Px(3);
